...
const Profile = () => {
  ...
  {loadingFavorites
    ...
    : favorites.map((v) => (
        <div
          key={v.id}
          className="relative overflow-hidden transition-transform border border-gray-800 rounded-lg cursor-pointer bg-gray-900/80 hover:border-pink-600 hover:scale-105"
        ...
        >
          <div className="relative">
            ...
            {/* ✅ Add this EXCLUSIVE badge if video is exclusive */}
            {v.exclusive && (
            ...
            {v.duration && (
              <span className="absolute bottom-1 right-1 px-2 py-0.5 text-xs font-semibold text-white bg-black/60 rounded">
                {v.duration}
              </span>
            )}
          </div>
